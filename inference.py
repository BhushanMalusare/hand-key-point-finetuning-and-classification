...
# Load TFLite model
interpreter = tf.lite.Interpreter(model_path="B:\hand_key_point_finetuned\quantized_models\classifier_quantized.tflite")
...
while cap.isOpened():
    ...
    # Get YOLO results
    results = yolo_model(frame, conf=yolo_conf_threshold, iou=0.45)
